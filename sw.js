...
const CACHE_NAME='everything-app-shell-v1.5D-'+encodeURIComponent(new URL(self.registration.scope).pathname);
const ASSETS=['./index.html','./app.js?v=1.5D','./accounts.js?v=1.5D','./styles.css?v=1.5D','./navigation.js?v=1.5D','./navigation-core.js?v=1.5D','./navigation.css?v=1.5D','./world-clock-core.js?v=1.5D','./world-clock.js?v=1.5D','./world-clock.css?v=1.5D','./transport-core.js?v=1.5D','./transport.js?v=1.5D','./transport.css?v=1.5D','./v1_5D.js?v=1.5D','./v1_5D.css?v=1.5D','./manifest.webmanifest','./icon.svg'];
